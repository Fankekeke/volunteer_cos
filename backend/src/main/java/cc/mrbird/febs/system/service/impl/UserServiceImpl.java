...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
     ...
     */
    @Override
    public void registSchool(String username, String password, SysSchool school) throws Exception {
        User user = new User();
        user.setPassword(MD5Util.encrypt(username, password));
        user.setUsername(username);
        user.setCreateTime(new Date());
        ...
        school.setUserId(Math.toIntExact(user.getUserId()));
        sysSchoolService.save(school);
