<template>
  <a-modal v-model="show" title="评论详情" @cancel="onClose" :width="850">
    ...
    <div style="font-size: 13px;font-family: SimHei" v-if="replyData !== null">
      ...
      <a-row style="padding-left: 24px;padding-right: 24px;">
        <a-col :span="8"><b>类型：</b>
          <a-tag v-if="replyData.type == 1">经销商</a-tag>
          <a-tag v-if="replyData.type == 2">批发商</a-tag>
          <a-tag v-if="replyData.type == 3">散客</a-tag>
          <a-tag v-if="replyData.type == 4">代理商</a-tag>
        </a-col>
        <a-col :span="8"><b>联系人：</b>
          {{ replyData.contact }}
        </a-col>
        <a-col :span="8"><b>性别：</b>
          <a-tag v-if="replyData.sex == 1" color="blue">男</a-tag>
          <a-tag v-if="replyData.sex == 2" color="pink">女</a-tag>
        </a-col>
      </a-row>
      <br/>
      <a-row style="padding-left: 24px;padding-right: 24px;">
        ...
        <a-col :span="8"><b>审核状态：</b>
          <a-tag v-if="replyData.status == 0">未审核</a-tag>
          <a-tag v-if="replyData.status == 1" color="red">审核驳回</a-tag>
          <a-tag v-if="replyData.status == 2" color="green">已审核</a-tag>
        </a-col>
      ...
      <a-row style="padding-left: 24px;padding-right: 24px;">
        <a-col :span="8"><b>审核时间：</b>
          {{ replyData.auditDate ? replyData.auditDate : '- -'}}
        </a-col>
        <a-col :span="8"><b>消费金额：</b>
          {{ replyData.price ? replyData.price : '- -'}}
        </a-col>
      </a-row>
      <br/>
      <br/>
      <a-row style="padding-left: 24px;padding-right: 24px;">
        ...
        <a-col :span="24">
          {{ replyData.remark ? replyData.remark : '- -'}}
        </a-col>
      </a-row>
      <br/>
      <a-col :span="24">
