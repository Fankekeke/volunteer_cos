<template>
  <a-modal v-model="show" title="修改评论" @cancel="onClose" :width="800">
  ...
  methods: {
    ...
    setFormValues ({...reply}) {
      ...
      Object.keys(reply).forEach((key) => {
        if (key === 'images') {
          this.fileList = []
          this.imagesInit(reply['images'])
        }
        // if (key === 'birthday' && reply[key] != null) {
        //   reply[key] = moment(reply[key])
        // }
